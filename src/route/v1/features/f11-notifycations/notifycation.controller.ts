...
@ApiTags('Notifycations')
@UseInterceptors(WrapResponseInterceptor)
@Controller()
export default class NotifycationController {
  constructor(private readonly notificationService: NotifycationService) {}
  ...
  @Post('')
  @HttpCode(201)
  async create(@Body() body: CreateNotifycationDto): Promise<any> {
  ...
  async update(
    ...
    @Body() body: UpdateNotifycationDto,
  ): Promise<any> {
